...
<body>
  ...
  <section id="header">
    <div class="header container">
      <div class="nav-bar">
        <div class="brand">
          <a href="#hero"><h1><span>B</span>ibliotecaApp </h1></a>
        </div>
        <div class="nav-list">
          ...
          <ul>
            ...
            <li><a href="{{route('dashboard')}}" data-after="Home">Adminitrador</a></li>
        @else
        <li><a href="{{route('register')}}" data-after="Home">Libros</a></li>
        @endif
  ...
  <section id="hero">
    <div class="hero container">
      <div>
        ...
        <h1>Biblioteca Umg <span></span></h1>
        <h1>Chiquimulilla, Santa Rosa <span></span></h1>
        <a href="{{route('login')}}" type="button" class="cta">Ingresar</a>
      </div>
    </div>
  </section>
  <!-- End Hero Section  -->
